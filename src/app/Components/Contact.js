          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <button
                ...
                className="group relative bg-primary text-white font-bold py-4 px-8 rounded-full hover:shadow-2xl transition-all duration-300 transform hover:scale-110 overflow-hidden"
              >
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-6 sm:p-8 shadow-2xl">
              ...
              <div className="text-center">
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-primary to-sky-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 pt-8 border-t border-gray-800">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-2xl mx-auto">
                {/* Instagram */}
                <a target='_blank' href="https://www.instagram.com/aycreativesolution" className="flex flex-col items-center justify-center bg-gray-800 rounded-lg p-6 hover:bg-gradient-to-br hover:from-cyan-600 hover:to-blue-500 transition-all duration-300 group transform hover:scale-105 hover:shadow-xl">
                ...
                {/* LinkedIn */}
                <a href="https://www.linkedin.com/company/aycreativesolution" target='_blank' className="flex flex-col items-center justify-center bg-gray-800 rounded-lg p-6 hover:bg-blue-700 transition-all duration-300 group transform hover:scale-105 hover:shadow-xl">
                  <div className="w-8 h-8 mb-2">
                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full text-gray-400 group-hover:text-white transition-colors duration-300 group-hover:animate-pulse">
                ...
                {/* YouTube */}
                <a href="https://www.youtube.com/@aycreativesolution" target='_blank' className="flex flex-col items-center justify-center bg-gray-800 rounded-lg p-6 hover:bg-red-600 transition-all duration-300 group transform hover:scale-105 hover:shadow-xl">
                  <div className="w-8 h-8 mb-2">
                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full text-gray-400 group-hover:text-white transition-colors duration-300 group-hover:animate-pulse">
